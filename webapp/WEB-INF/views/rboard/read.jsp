			...
			<div id="c_box">
				<div id="board" class="board-form">
					...
					<div class="bottom">
						...
						<a href="${pageContext.request.contextPath}/rboard/commentform?no=${boardvo.no}">댓글달기</a>
						<a href="${pageContext.request.contextPath}/rboard/list">글목록</a>
						<c:if test="${not empty sessionScope.authUser}">	
						<a href="${pageContext.request.contextPath}/rboard/modifyform?no=${boardvo.no}">글수정</a>
